                            ...
                            <div className='w-full border-t'>
                                {
                                    cart && cart.map((i,index) => (
                                        <CartSingle key={index} data={i} quantityChangeHandler={quantityChangeHandler} removeFromCartHandler={removeFromCartHandler}></CartSingle>
                                    ))
                                }
                            </div>
                        </div>
    ...
    return(
        <div className="border-b p-4">
            <div className="w-full flex items-center">
                <div>
                    <div className={`bg-[#e44343] border border-[#e4434373] rounded-full w-[25px] h-[25px] ${styles.noramFlex} justify-center cursor-pointer`}
                        onClick={() => increment(data)}
                    >
                        <HiPlus size={18} color='#fff'></HiPlus>
                    ...
                    >
                        <HiOutlineMinus size={16} color='#7d879c'></HiOutlineMinus>
                    </div>
                </div>
                ...
                <RxCross1 className='cursor-pointer' onClick={()=>removeFromCartHandler(data)}></RxCross1>
            </div>
        </div>
    )
}
