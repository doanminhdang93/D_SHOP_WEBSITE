...
const Header = ({ activeHeading }) => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`${styles.section} relative ${styles.noramFlex} justify-between`}
        >
          {/* Categories */}
      ...
      <div
        className={`${
          active === true ? "shadow-sm fixed top-0 left-0 z-10" : null
        } w-full h-[60px] bg-[#f6f6f5] z-50 top-0 left-0 shadow-sm 800px:hidden`}
      >
                    ...
                    <div>
                      <Link to="/profile">
                        <img
                          src={`${backend_url}${user.avatar}`}
                          alt=""
                          className="w-[60px] h-[60px] rounded-full border-[3px] border-[#2ea59b]"
                        />
                      </Link>
                    </div>
                  </>
